...
const char* options = "hvsLIiP";
const char* helpStr =
    "Description:\n"
    "\tRenames all files inside the given folders to their lower (default),\n"
    "\tupper or inverse case equivalents. By default, the parent directories\n"
    "\tthemselves are not renamed.\n"
    "Usage:\n"
    "\tbulk-rename [-hvsPLIi] parent-dir [more-parent-dirs]\n"
    "Options:\n"
    "\t-h: Prints this helpful text and exits\n"
    "\t-v: Enables verbose mode\n"
    "\t-s: Enables silent mode\n"
    "\t-P: Renames the parent directories too\n"
...
int main(int argc, char* argv[])
{
    ...
    printf("!!! WARNING OPERATION IRREVERSIBLE !!! \n"
           "Are you sure you want to rename the specified target(s)? \n"
           "Enter 'y' to commence or 'n' to abort operation \n");

    printf("Targets about to be renamed:\n");
